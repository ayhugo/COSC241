...
public class LinkedBST<T extends Comparable<T>> {
    ...
    public int height() {
        ...
        if (left != null){
            leftHeight ++;
            return leftHeight += left.height();
        }
        if (right != null){
            rightHeight ++;
            return rightHeight += right.height();
        }
    ...
    public int sizeAbove(T low) {
        ...
        if(root == null){
            ...
            int compareLow = root.compareTo(low);
            if (compareLow == 0){
                if (right != null){
                    return 1 + right.size();
                }
    ...
    public int sizeBelow(T high) {
        ...
        if(root == null){
            ...
            int compareHigh = root.compareTo(high);
            if (compareHigh == 0){
                if (left != null){
                    return 1 + left.size();
                }
    ...
    public int sizeBetween(T low, T high) {
        ...
        if (root == null){
            ...
            if (0 < compareLow && 0 > compareHigh){
                numHigh += size() - sizeBelow(high);
                numLow += size() - sizeAbove(low);
                between += size() - numHigh - numLow;
            }
        }
        return between;
    }
